<?php get_header(); ?>
    ...
    <section class="sec">
        <div class="container">
            ...
            <!-- template-partsのloop-news.phpのループ -->
            <div class="row">
                <?php if ( have_posts() ) : ?>
            ...
            <!-- template-partsのloop-news.phpのループ終わり -->

            <p class="sec_btn">
                <?php
                $news = get_term_by( 'slug', 'news', 'category');
                $news = get_term_link($news, 'category');
                ?>
    ...
    <section class="sec bg-gray">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="<?php echo get_permalink(41); ?>" class="bnr" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/home/bnr_access@2x.jpg')">
                        <div class="bnr_inner">
